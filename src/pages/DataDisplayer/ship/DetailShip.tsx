...
interface DetailShipProps {
  className?: string;
}

export default function DetailShip({ className }: DetailShipProps) {
    ...
    <div className="">
      ...
      <div className="bg-[#121714] mt-4 rounded-md text-white m-2">
        <div className="flex flex-row justify-between">
          <h1 className="text-4xl font-semibold">Ship Detail</h1>
          <Link
            to="/data-displayer/list-ship"
            className="text-xl p-2 flex my-auto hover:bg-[#1D2420] hover:rounded-xl"
          >
            <p>
              Back to Home <span className="font-bold text-xl">→</span>
            </p>
          </Link>
        </div>
        ...
        <div className="flex mt-8 gap-4 md:flex-row ">
...
//         <div className="flex flex-row justify-between">
//           <h1 className="text-4xl font-semibold">Ship Detail</h1>
//           <button className="text-xl p-2  flex my-auto hover:bg-[#1D2420] hover:rounded-xl">
//             <p>
//               Back to Home <span className="font-bold text-xl">→</span>
//             </p>
//           </button>
